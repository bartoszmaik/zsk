...
<html lang="pl">
  ...
  <body>
      ...
      <nav class="navbar shadow navbar-dark navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="menu">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="learn.php">Ucz się</a>
                </li>
    ...
    <h2 class="center my-5 col-md-12">E.12<hr class="text-dark"></h2>

      <aside class="col-md-4">
        <h2 class="center">Działy</h2>

        <button class="dropdown-btn">Dział 1</button>
        <div class="dropdown-container">
          <div class="white dropdown-divider"></div>
          <a href="#">Słowniczek</a>
          <div class="dropdown-divider"></div>
          <a href="#">Test</a>
        </div>

      <button class="dropdown-btn">Dział 2</button>
      <div class="dropdown-container">
        <div class="white dropdown-divider"></div>
        <a href="#">Słowniczek</a>
        <div class="dropdown-divider"></div>
      ...
      <button class="dropdown-btn">Dział 3</button>
      <div class="dropdown-container">
        <div class="white dropdown-divider"></div>
        <a href="#">Słowniczek</a>
        <div class="dropdown-divider"></div>
    ...
    <div class="col-md-8 main">
      <p class="my-5"> E.12 - Montaż i eksploatacja komputerów osobistych oraz urządzeń peryferyjnych. Kurs obejmuje słownictwo z zakresu systemów operacyjnych oraz podzespołów komputerowych</p>

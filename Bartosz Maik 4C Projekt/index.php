...
<div class="container">
        ...
        <div class="maindesc row">
          <h1 class="mbot col-md-12">Zacznij naukę angielskiego już dziś z Ponglish!<hr class="text-dark"></h1>
          <div class="mbot col-md-6"><p>Z Ponglish zdobędziesz niezbędne umiejętności językowe do pracy w zawodzie. Znajomość angielskiego zawodowego
            efektywnie wpłynie na twoją pracę, co może przełożyć się na większe wynagrodzenie!</p>
            <p>Rozpocznij naukę języka angielskiego zawodowego już teraz!<br>
            Wystarczy, że założysz swoje konto i zapiszesz się na jeden z bezpłatnych kursów!</p>
            <a href="login.php"><button type="button" class="start btn btn-dark">Zacznij już teraz!</button></a>
          </div>

          <div class="col-md-6">
            <img src="images/stonks.png" class="img-fluid stonks">
          </div>
        ...
        <div class="desc row">
          <h2 class="col-md-12">Aktualności</h2>
          <div class="col-md-6">

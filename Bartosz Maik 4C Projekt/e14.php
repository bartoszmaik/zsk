...
<html lang="pl">
  ...
  <body>
    ...
    <h2 class="center my-5 col-md-12">E.14<hr class="text-dark"></h2>
    ...
    <div class="col-md-8 main">
      <p class="my-5">E.14 - Tworzenie aplikacji internetowych i baz danych oraz administrowanie bazami. Kurs obejmuje słownictwo z zakresu baz danych oraz aplikacji internetowych.</p>
